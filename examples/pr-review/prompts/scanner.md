...
4. For each pull request that remains, call `layover_spawn` once, addressed to `reviewer`, with
   the pull request identifier, its repository, and its current commit.
